...
#define CUSTOM_MACHINE_NAME "Pussy 3D"
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (100*60) // change de (80*60) a (100*60) comme A8
#define HOMING_FEEDRATE_Z  (6*60) // anet (4*60) mais trop lent (origine (7*60))
